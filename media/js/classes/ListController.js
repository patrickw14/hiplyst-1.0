    ...
    $.ajax({
        ...
        success: function (data) {
            if (data["status"] == "OK") {
                ...
                gui.user_gui.ui_recommendations.html("You need to <a href='#' onclick='return Player.toggleLastfm();'>login</a> to last.fm");
                _this.player.fireEvent("RecommendationsUpdateError");
            }
        },
        error: function() {
            gui.user_gui.ui_recommendations.html("Server error");
            _this.player.fireEvent("RecommendationsUpdateError");
        }
    });
};
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data["status"] == "OK") {
                ...
                gui.recommendations_gui.ui_recommend_covers.html("You need to login to last.fm");
                _this.player.fireEvent("BigRecommendationsUpdateError");
            }
        },
        error: function() {
            gui.recommendations_gui.ui_recommend_covers.html("Server error");
            _this.player.fireEvent("BigRecommendationsUpdateError");
        }
    });
};
